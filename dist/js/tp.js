(function () {
...
})()(
  {
      ...
      function (require, module, exports) {
        ...
        var tp = {
                  ...
                  if (res.data && res.data.length) {
                    for (var i = 0; i < res.data.length; i++) {
                      res.data[i].blockchain =
                        BLOCKCHAIN_ID_MAP[res.data[i].blockchain_id + ""] ||
              ...
              window[tpCallbackFun] = function (result) {
                ...
                try {
                  ...
                  if (res.data && res.data.blockChainId) {
                    res.blockchain =
                      BLOCKCHAIN_ID_MAP[res.data.blockChainId + ""] ||
                      res.data.blockChainId;
                  }
          ...
          forwardNavigationGesturesEnable: function (params) {
            _sendTpRequest(
              "forwardNavigationGesturesEnable",
              JSON.stringify(params),
              ""
            );
          },
          ...
          eosTokenTransfer: function (params) {
            ...
            if (
              ...
              throw new Error(
                'missing params; "from", "to", "amount", "contract", "precision" is required '
              );
            }
          ...
          getEosBalance: function (params) {
            if (!params.account || !params.contract || !params.symbol) {
              throw new Error(
                'missing params; "account", "contract", "symbol" is required '
              );
            }
          ...
          enuTokenTransfer: function (params) {
            ...
            if (
              ...
              throw new Error(
                'missing params; "from", "to", "amount", "tokenName","contract", "precision" is required '
              );
            }
          ...
          moacTokenTransfer: function (params) {
            if (
              ...
              throw new Error(
                'missing params; "from", "to", "amount", "gasLimit", "tokenName" is required '
              );
            }
                ...
                try {
                  ...
                  if (res.result && res.data && res.data.signatures) {
                    es.data.signatures.forEach(function (item) {
                      item.signature =
                        item.signature && Buffer.from(item.signature);
                      item.pub_key.value =
                        item.pub_key.value && Buffer.from(item.pub_key.value);
                    });
                  }
          ...
          btcTokenTransfer: function (params) {
            if (!params.from || !params.to || !params.amount) {
              throw new Error(
                'missing params; "from", "to", "amount" is required '
              );
            }
    ...
    14: [
      ...
      { "base64-js": 13, buffer: 14, ieee754: 15 },
    ],
    15: [
      function (require, module, exports) {

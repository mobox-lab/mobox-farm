<template>
  <div class="pet_item por" :class="'pet_hover_lv' + getNowVType">
    <img
      ...
      alt=""
      @click.stop="quickBuy(getShowList[0].prototype)"
      v-if="getShowList.length == 1"
    />
    <div ref="container" class="swiper-container dib" :id="data.item.tx">
      <div class="swiper-wrapper">
        ...
        >
          ...
          />
          <div
            style="position: absolute; width: 100%; bottom: 100px; left: 0px"
          >
          ...
          <div class="pet-power vertical-children mgt-20">
            ...
            <span :class="getHashrateColor(item)" style="font-size: 25px">{{
              item.lvHashrate
            }}</span>
          </div>
        </div>

		...
		<Dialog id="connect-wallet-dialog" :top="100" :width="400">
			...
			<div class="mgt-20">
				...
				<div class="connect-wallet-item aveage-box mgt-10" @click="connectWallet('TrustWallet')">
					...
					<div class="tar">
						<img style="margin-top:5px" src="../assets/icon/trust-wallet.png" height="30" alt="">
					</div>
				</div>
				...
				<div class="connect-wallet-item aveage-box mgt-10" @click="connectWallet('metamask')">
					...
					<div class="tar">
						<img style="margin-top:5px" src="../assets/icon/metamask.svg" height="30" alt="">
					</div>
				</div>
				...
				<div class="connect-wallet-item aveage-box mgt-10" @click="connectWallet('walletConnect')">
					...
					<div class="tar">
						<img src="../assets/icon/safepal.png" style="margin-top:5px" height="30" alt="">
					</div>
				</div>
			</div>
		</Dialog>
	...
	methods:{
		...
		async connectWallet(type){
			...
			switch (type) {
				...
				case "TrustWallet":
					if (typeof window.ethereum !== 'undefined') {
						const mp = window.ethereum?.providers?.find((item) => item.isTrustWallet) || window.ethereum;

<template>
  <div class="tac center-content">
        ...
        <div class="por">
          <div class="vertical-children">
            ...
            <img
              ...
              @click="oprDialog('box-rule-dialog', 'block')"
          ...
          <div class="tac mgt-10">
            <template>
              <p v-if="getCountDown > 0">
                {{ $t("NewBOX_20") }}: {{ getLeftTime(getCountDown) }}
              </p>
            ...
            <div class="mgt-10 aveage-box">
              <div class="dib por tac">
                <button
                  ...
                  @click="oprDialog('box-apply-dialog', 'block')"
                >
                  {{ $t("NewBOX_14") }}
                </button>
              </div>
          ...
          <section style="padding: 10px">
            ...
            <div class="aveage-box tal" style="padding: 15px">
              <div class="por">
                ...
                <div style="position: absolute; right: 10px; top: 0px"></div>
              </div>
              <div>
                <p class="small vertical-children">
    ...
    <div class="col-md-12" :class="{ hide: !showRank }">
      <section
        class="mgt-10"
        style="padding: 10px 15px; background: #13181f; border-radius: 10px"
      >

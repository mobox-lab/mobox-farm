<template>
  <div class="tac center-content">
    <div
      class="por clear mgt-20"
      style="border: 1px solid #5d636f80; border-radius: 30px"
    >
        ...
        <div class="adv-panel por">
          <h1 class="vertical-children">
            ...
            <img
              ...
              @click="oprDialog('mdx-rule-dialog', 'block')"
            ...
            <div style="height: 280px" id="gem-apply-type" class="por">
              ...
              <p style="position: absolute; bottom: 60px; right: 0px">
                <a
                  ...
                  href="https://bsc.mdex.co/#/swap?inputCurrency=0x9c65ab58d8d978db963e63f2bfb7121627e3a739&outputCurrency=0xe9e7cea3dedca5984780bafc599bd69add087d56"
                >
      ...
      <section class="col-md-5" style="padding: 10px">
        <div class="panel por" style="height: 385px; padding: 10px">
          <section style="padding: 10px">
            <div
              class="aveage-box tal"
              style="border-bottom: 1px solid #2f3236; padding: 15px"
            >
              <div>
            ...
            <div class="aveage-box tal" style="padding: 15px">
              <div>
                ...
                <h3>
                  {{ applyInfo.nowHighAmount }}/{{
                    applyInfo.maxHighLuckyAmount
                  }}
                </h3>
              </div>
              <div>
                ...
                <h3>
                  {{
                    numFloor(
                      (applyInfo.maxHighLuckyAmount /
                        (Number(applyInfo.nowHighAmount) >=
                        Number(applyInfo.maxHighLuckyAmount)
                          ? applyInfo.nowHighAmount
                          : applyInfo.maxHighLuckyAmount)) *
                        100,
                      1e3
          ...
          <div class="mgt-20 aveage-box">
            ...
            <div class="tac">
              <StatuButton
                ...
                :isLoading="lockBtn.takeMdxBoxLock > 0"
                :onClick="takeBox"
              >
                {{
        ...
        <div
          class="gemBag"
          @click="oprDialog('boxBag-dialog', 'block')"
          style="bottom: 20px"
        >
          <span class="notice-num" v-if="getTotalBoxNum > 0">{{
            getTotalBoxNum
          }}</span>
          <img src="@/assets/box/boxbagicon.png" alt="" height="60" class="" />
          <p class="stroke" :data-text="$t('Air-drop_262')">
            {{ $t("Air-drop_262") }}
          </p>
        </div>
      </section>
      ...
      >
        <table class="small new-table" border="0" frame="void" rules="none">
          ...
          <tr v-for="item in getHistory" :key="item.tx">
            ...
            <td class="tal">
              <span v-if="Number(item.ticketStartNo) > 1e6">{{
                $t("NewBOX_25")
              }}</span>

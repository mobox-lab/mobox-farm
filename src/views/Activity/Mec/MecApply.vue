	...
	<Dialog id="mecBox-apply-dialog" :top="100" :width="400">
		...
		<div class="mgt-50">
			...
			<div  :class="{'btn-group': mboxAllownceToApply == 0}">
				...
				<StatuButton :isLoading="lockBtn.applyBuyLock > 0" :isDisable="mboxAllownceToApply <= 0 || !isCanApply" data-step="2" class="mgt-10" style="width:70%"  :onClick="()=>applyBuy(dialog_tab_pos == 0?'hashRateApplyFor':'veMoboxApplyFor')">
					<template >

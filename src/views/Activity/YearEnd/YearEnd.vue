  ...
  <div class="layout">
    ...
    <div class="container">
      ...
      <div class="task-content">
        <div class="card-item complete-item" v-if="complete">
        ...
        <div class="card-item" v-else>
          <div class="box tasks-box">
            ...
            <div class="describe">
              <p>
                Daily Check-in resets everyday. Every 10 canes unlocks 1 wreath
                towards raffle eligibility.
                <br />
                Note: maximum 3 wreaths required, additional wreaths
                <span class="not-equal">≠</span> higher chance to win.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="card-item raffle-item">
          ...
          <div class="box" v-if="complete">
            ...
            <div class="not-prize">
              ...
              <p>
                Winners will be announced post-event via official announcement,
                all rewards will be sent directly to winning addresses.
              </p>
            </div>
          </div>
          <div class="box raffle" v-else>
            ...
            <h5 class="title">Raffle</h5>
            <p class="tip">
              MOMO Canes can be converted to MOMO Wreaths in a ratio of: <br />

              <img src="@/assets/yearEnd/canes.webp" /> x10 Canes =
              <img src="@/assets/yearEnd/chest.webp" /> x1 wreaths
              <!-- Get 3 *

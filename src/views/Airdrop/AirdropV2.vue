  ...
  <div class="tac por" style="padding-bottom: 50px">
      ...
      <section class="por airdrop-cont" style="z-index: 10">
        ...
        >
          ...
          <div class="swiper-wrapper tac">
            ...
            <div
              id="halloween-entry"
              class="swiper-slide tac"
              style="width: 100%; margin: 0 auto"
              v-if="myNFT_verse.length"
            >
              <img
                src="@/assets/transMoMo.png"
                @click="oprDialog('transfer-dialog', 'block')"
                alt=""
                width="60%"
              />
            </div>
        ...
        <div class="tal vertical-children tac-xs">
          <img
            class="mgt-30 hide-xs"
            src="@/assets/airdrop_icon.png"
            width="200"
            alt=""
          />
        ...
        <div class="row ovh mgt-10" style="padding: 4px">
          <div
            class="aveage-box vertical-children"
            ...
            >
              ...
              <div style="padding: 20px" class="por ovh" id="mbox-panel">
                <div class="col-md-5 aveage-box" style="align-items: start">
                  ...
                  >
                    <div
                      class="dib airdorp-item-coin-icon tac por"
                    ...
                    <div class="tal" style="margin-left: 15px">
                      ...
                      <h3 class="mgt-5 new-text">
                        ${{ numFloor(item.totalSupply, 1).toLocaleString() }}
                      </h3>
                    </div>
                  </div>

                  <div>
                    <p class="color-w tal small opa-6">
                      {{ $t("Air-drop_205") }}
                    </p>
                    <div
                      class="point-block close"
                      @click="
                        getApyObj(item);
                    ...
                    >
                      <div class="tal">
                        <h4
                          class="vertical-children new-text"
                      ...
                      >
                        ...
                        >
                          ...
                          <p class="dib tar">
                            <span v-if="item.myApy.lpFee != '-'"
                              >{{
                                numFloor(item.myApy.lpFee * 100, 100)
                              }}%</span
                            >
                            <Loading v-else />
                          </p>
                        ...
                        <div
                          v-if="
                            item.wantAmount > 0 && item.maxApyNeedVeMobox != '-'
                          "
                          class="tac mgt-10"
                        >
                ...
                <div class="col-md-7 aveage-box" style="align-items: start">
                  ...
                  >
                    <div>
                      ...
                      <div
                        class="tal"
                        style="flex: 2"
                        v-if="item.wantAmount != '-'"
                      >
                        <h3
                          v-if="item.wantAmount > 0"
                          class="vertical-children notice-color new-text"
                          :class="item.isLP ? 'show-point-block' : ''"
                        >
                        ...
                        <h3 v-else style="padding: 5px; display: inline-block">
                          0
                        </h3>
                      </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <p class="dib tar">
                          <span
                            class="mgl-10"
                            v-if="item.lpPrice[key] != '-'"
                            >{{ item.lpPrice[key] }}</span
                          >
                          <Loading v-else />
                          <img
                            class="mgl-5 hide-xs"
                  ...
                  <div class="tal">
                    ...
                    >
                      {{
                        numFloor(
                          (Number(
                            coinArr[item.coinKey].veMbox.orderIndexs[0]
                              .veMboxNum
                          ) +
                            Number(
                  ...
                  <div class="tal">
                    ...
                    <p class="mgt-5">
                      <button
                        class="btn-success btn-small por new-text"
                ...
                <div
                  class="aveage-box col-md-12 mgt-20"
                  style="
                    background: #070d14;
                    border-radius: 10px;
                    padding: 10px 0px;
                ...
                >
                  ...
                  <!-- <a class="dib por tac" href="https://pancakeswap.finance/swap?outputCurrency=0x3203c9e46ca618c8c1ce5dc67e7e9d75f5da2377" target="_blank" >
                  ...
                  >
                    ...
                    <img
                      class="cur-point"
                      width="40"
                      src="../../assets/icon/exchange_icon.png"
                      alt=""
                    />
                    <span
                      style="
      ...
      <section class="por airdrop-cont">
        <div class="tal">
          ...
          <div class="aveage-box block-xs">
            <p class="small-xs mgt-10 hide-xs opa-6">
              {{ $t("Air-drop_234") }}
            </p>
            <div class="tar mgt-10 tal-xs">
              <button
                ...
                @click="
                  howToPlayPos = 0;
                  oprDialog('how-to-play-dialog', 'block');
                "
              >
                {{ $t("Air-drop_226") }}
              </button>
              <button
                class="btn-liling mgl-5"
                @click="
                  howToPlayPos = 1;
                  oprDialog('how-to-play-dialog', 'block');
                "
              ...
              <div>
                ...
                <p class="bold2 vertical-children" style="margin-top: 5px">
                  ...
                  <span
                    ...
                    v-if="eth_totalHashrate != '-'"
                    >{{ eth_totalHashrate.toLocaleString() }}</span
                  >
              ...
              <div>
                ...
                <p class="bold2 vertical-children" style="margin-top: 5px">
                  ...
                  <span
                    class="mgl-5"
                    style="font-size: 16px"
                    v-if="totalAirdropMbox != '-'"
                    >{{ totalAirdropMbox.toLocaleString() }}</span
                  >
                  <Loading class="mgl-5" v-else />
                </p>
              </div>
        ...
        <section class="hide">
          ...
          <section id="buy-back" class="mgt-20 por">
            ...
            <div
              class="aveage-box"
              style="background: #1c222c; border-radius: 10px"
            >
              <div style="padding: 10px">
                ...
                <input
                  ...
                  :value="
                    ...
                    '(' +
                    numFloor(
                      (totalStakeMbox / buyBack.circulating) * 100,
                      100
                    ) +
                    '%)'
                  "
              ...
              <div style="padding: 10px" class="por">
                ...
                <span
                  ...
                  "
                  @click="
                    $root.$children[0].$refs.vmbox
                      .setOprData(coinArr['GOV'])
                      .show()
                  "
                >
                  <span
          ...
          <section id="buy-back" class="mgt-20 por">
            ...
            >
              ...
              <tr>
                <td colspan="6">
                  <a
                    href="https://bscscan.com/address/0x1846c0ab8D09007154066Cbb114315e11D94D4E8"
                    target="_blank"
                    >{{ $t("Air-drop_148") }}</a
                  >
                </td>
    ...
    <Dialog id="mbox-take-des-dialog" :top="180" :width="420">
      ...
      <p class="dib tal mgt-10">
        {{ $t("Air-drop_199") }}:
        <span class="notice-color">{{
          numFloor(getPledgeList[0].veMoboxSupply / 1e18, 1).toLocaleString()
        }}</span>
      </p>
      <p class="mgt-10 tab-body tal" style="padding: 15px">
        {{ $t("Air-drop_225") }}
      </p>
    </Dialog>
    ...
    <Dialog id="how-to-play-dialog" :top="100" :width="350">
      ...
      <template v-if="howToPlayPos == 0">
        <div
          class="tab-body tal"
          v-html="$t('Air-drop_228')"
          style="padding: 15px; max-height: 450px; overflow-y: auto"
        ></div>
        <div class="mgt-10">
          <button
            class="btn-primary"

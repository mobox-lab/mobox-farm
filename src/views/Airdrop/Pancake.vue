  ...
  <div>
    <Dialog id="pancake-dialog" :top="100" :width="600">
      ...
      <div class="tal mgt-10 menu-box">
        ...
        <a
          href="https://www.binance.org/cn/bridge"
          target="_blank"
          class="menu-item"
      ...
      <div class="por tab-body-box">
        <div class="pancake-setting" v-if="oprData.isLP || dialog_tab_pos != 1">
          <div class="dib por">
            ...
            <span
              class="notice"
              v-if="setting.duration == '' || Number(setting.slippage) < 0.5"
            ></span>
          </div>
          <div class="dib por">
            <svg
              @click="oprDialog('pancake-history-dialog', 'block')"
              viewBox="0 0 24 24"
      ...
      <div class="tab-body mgt-10">
        <div class="tab-panel" style="min-height: 200px">
          <table style="width: 100%">
            <tr
              v-for="item in [...pancakeHistory].reverse()"
              :key="item.hash"
              class="tal"
            >
          ...
          <div class="tac mgt-20" v-if="pancakeHistory.length == 0">
            {{ $t("Air-drop_46") }}
          </div>
        </div>
      </div>

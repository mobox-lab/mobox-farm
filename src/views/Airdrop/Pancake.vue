				...
				<div class="tab-panel" style="min-height:200px">
					<table style="width:100%">
						<tr v-for="item in [...pancakeHistory].reverse()" :key="item.hash" class="tal">
							...
							<td >
								<a :href="'https://bscscan.com/tx/' + item.hash" target="_blank" style="text-decoration: underline;" class="vertical-children">
									<span>{{item.msg}}</span>
									<img src="../../assets/icon/viewTx.png" class="mgl-10" height="20" alt="" />
								</a>
							</td>
						</tr>
					</table>

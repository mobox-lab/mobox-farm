<template>
	<div :class="['pet_hover_lv' +getVType(item.prototype),{'opa-6': item.isLock || isRent}]" @click="addNum()" class="shop-car-item  vertical-children por mgt-10 por">
			<img class="tip-icon" v-if="showTipIcon && !isStandard" src="@/assets/icon/warning-icon.png" />
			...
			<div class="dib small mgl-5">
				...
				<p class="vertical-children mgt-5">
					...
					<span class="mgl-5"> {{ item.tokenName.indexOf("Name_") == -1? shortStr(item.tokenName) : $t(item.tokenName) }} </span>
				</p>
			</div>
			<!-- 宝石 -->
			<div class="jewel" >

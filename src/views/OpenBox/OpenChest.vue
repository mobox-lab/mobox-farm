    ...
    <div class="clear mgt-10">
      <section class="col-md-7" style="padding: 10px">
        <div class="adv-panel">
          ...
          <div
            class="por box"
            style="height: 322px; width: 300px; margin: 0px auto"
          >
          ...
          <div id="show-card" class="hide" @click="initCardAnime">
            <div id="show-card-cont" class="animate__animated animate__zoomIn">
              ...
              <div
                v-if="posArr[petDataArr.length].line1"
                class="card-cont-row"
                id="show-card-cont-row1"
              >
                <div
                  class="show-card-item dib cur-point"
                  v-for="key in posArr[petDataArr.length].line1"
                  :key="key + 10"
                ...
                >
                  ...
                  <div class="back">
                    <PetItem
                      style="zoom: 0.72"
                      v-bind:data="{ item: petDataArr[key - 1] }"
                    />
                  </div>
                </div>
              </div>
              <div
                v-if="posArr[petDataArr.length].line2"
                class="card-cont-row"
                id="show-card-cont-row2"
              >
                <div
                  class="show-card-item dib cur-point"
                  v-for="key in posArr[petDataArr.length].line2"
                  :key="key + 20"
                  v-on:animationend="animationend"
                  @click="openCard"
                >
                  ...
                  <div class="back">
                    <PetItem
                      ...
                      v-bind:data="{
                        item: petDataArr[
                          key + posArr[petDataArr.length].line1 - 1
                        ],
                      }"
                    />
                  </div>
              ...
              <div
                v-if="posArr[petDataArr.length].line3"
                class="card-cont-row"
                id="show-card-cont-row3"
              >
                <div
                  class="show-card-item dib cur-point"
                  v-for="key in posArr[petDataArr.length].line3"
                  :key="key + 30"
                  v-on:animationend="animationend"
                  @click="openCard"
                >
                  ...
                  <div class="back">
                    <PetItem
                      ...
                      v-bind:data="{
                        item: petDataArr[
                          key +
                            posArr[petDataArr.length].line1 +
                            posArr[petDataArr.length].line2 -
                            1
                        ],
                      }"
                    />
              ...
              <div class="aveage-box">
                <div class="tal">
                  <button
                    ...
                    @click="
                      setAction(23011);
                      oprDialog('get-chest-dialog', 'block');
                      addKey =
                        parseInt(ethState.box) > 200
                          ? 200
                          : parseInt(ethState.box) || 0;
                    "
                  >
                    {{ $t("BOX_04") }}
                  </button>
      ...
      <div class="ly-input-content mgt-20">
        ...
        <div class="por mgt-5">
          ...
          <input
            ...
            v-int
            :data-max="
              parseInt(ethState.box) > 200 ? 200 : parseInt(ethState.box) || 0
            "
            data-min="1"
            v-model="addKey"
          />
...
export default {
  ...
  mounted() {
    ...
    if (this.isOpening) {
      document
        .getElementById("openbox-anime")
        .classList.add("animation-box-start");
    }
  },
  beforeDestroy() {
  ...
  methods: {
    ...
    openAnime() {
      ...
      document
        .getElementById("openbox-anime")
        .classList.remove("animation-box-start");

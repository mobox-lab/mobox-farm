      ...
      >
        <div class="vertical-children">
          <div
            ...
            v-if="oprData.coinKey != ''"
            style="height: 40px; zoom: 0.5"
            class="dib por"
          >
            <img
        ...
        <div class="aveage-box mgt-20">
          ...
          <p>
            <span v-if="Number(orderIndexsCountDown['0']) > 0">
              ...
              <span v-else>
                &gt;{{ parseInt(Number(orderIndexsCountDown['0']) / 86400) }}
                {{ $t('Hire_46') }}
              </span>
            </span>
            <span v-else>
              ...
              <StatuButton
                :isLoading="lockBtn.unStakeMboxLock > 0"
                :onClick="unstakeMbox.bind(this, 0)"
                v-else
                class="btn-small"
                style="width: 70%"
                >{{ $t('Air-drop_155') }}</StatuButton
              >
            </span>
          </p>
        </div>
        <div class="aveage-box mgt-20">
          ...
          <p>
            <span v-if="Number(orderIndexsCountDown['1']) > 0">
              ...
              <span v-else>
                &gt;{{ parseInt(Number(orderIndexsCountDown['1']) / 86400) }}
                {{ $t('Hire_46') }}
              </span>
            </span>
            <span v-else>
              ...
              <StatuButton
                :isLoading="lockBtn.unStakeMboxLock > 0"
                :onClick="unstakeMbox.bind(this, 1)"
                v-else
                class="btn-small"
                style="width: 70%"
                >{{ $t('Air-drop_155') }}</StatuButton
        ...
        <div class="aveage-box mgt-20">
          ...
          <p>
            <span v-if="Number(orderIndexsCountDown['2']) > 0">
              ...
              <span v-else>
                &gt;{{ parseInt(Number(orderIndexsCountDown['2']) / 86400) }}
                {{ $t('Hire_46') }}
              </span>
            </span>
            <span v-else>
              ...
              <StatuButton
                :isLoading="lockBtn.unStakeMboxLock > 0"
                :onClick="unstakeMbox.bind(this, 2)"
                v-else
                class="btn-small"
                style="width: 70%"
                >{{ $t('Air-drop_155') }}</StatuButton
